...
- CD suele ser:
  a. En contextos naturalistas en lugar del salón de clase
  ...
  -Depende del similitud entre los sistemas.
...
.pull-left[
#### Figura 3: Ploteos de intensidad de la variable dependiente por grupo dialectal
...
#### Figura 9: Diagramas de dipsersión de la variable dependiente y la frecuencia de token con una regresión lineal simple por grupo.
```{r, echo=FALSE}
...
#### Figura 10: Ploteos de caja de la variable dependiente por hablante (coloreado por grupo)
```{r, echo=FALSE}
...
#### Figura 11: Ploteos de densidad de la variable dependiente por hablante (coloreado por grupo)
```{r, echo=FALSE}
...
.pull-left[
#### Figura 12: Nube de palabra de los ítems léxicos del grupo CHI-IN-SITU
```{r, echo=FALSE}
...
.pull-left[
#### Figuras 13: Nube de palabra de los ítems léxicos del grupo CHI-EN-CDMX
```{r, echo=FALSE}
...
.pull-left[
#### Figura 14: Nube de palabra de los ítems léxicos del grupo CDMX-IN-SITU
```{r, echo=FALSE}
...
- En mi tesis, voy a emplear diferentes diferentes pruebas estadísticas
...
- Facilita el entendimiento de la /d/ intervocálica como un fenómeno continuo como se ha hecho en otros dialectos del español
--
...
- Los datos muestran evidencia a favor de la acomodación dialectal, a "formas intermedias"

- ¿Un procesos automático? `r Citep(myBib, 'siegel_second_2010')` (p. 74) 
